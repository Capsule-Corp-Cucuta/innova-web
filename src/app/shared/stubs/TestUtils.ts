...
export class TestUtils {
  ...
  static advisory: Advisory = {
    ...
    date: new Date(),
    type: AdvisoryType.INICIAL,
    durationInHours: 2,
    preparationTimeInHours: 3,
    area: AdvisoryArea.RECURSOS_HUMANOS,
    subject: 'Prueba 1',
    notes:
  ...
  static advisorys: Advisory[] = [
    ...
    },
    {
      ...
      clientId: TestUtils.client.id,
      date: new Date(),
      type: AdvisoryType.SEGUIMIENTO,
      durationInHours: 3,
      preparationTimeInHours: 5,
      area: AdvisoryArea.RECURSOS_HUMANOS,
      subject: 'Prueba 2',
      notes: 'Pruebas de asesoria 2',
      state: AdvisoryState.PENDIENTE,
    },
  ];
